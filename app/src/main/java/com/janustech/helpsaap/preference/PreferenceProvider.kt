...
open class PreferenceProvider<T>(private val key: String, private val default: T) :
    ...
    override fun getValue(thisRef: Any?, property: KProperty<*>): T {
        ...
        return when (default) {
            ...
            is Double -> prefSharedPreferences.getString(key, default.toString())?.toDouble() as T
